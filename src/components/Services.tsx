    ...
    <section id="services" className="py-16 md:py-24 bg-gradient-to-b from-slate-50 to-white">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          {/* ✅ Payment Gateway Trust Badge - Builds instant credibility */}
          <motion.div
            initial={{ opacity: 0, y: 10 }}
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-lg shadow-sm border border-slate-200">
              {regionConfig.region === 'india' ? (
                <>
                  <svg className="w-20 h-6" viewBox="0 0 120 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    {/* Razorpay Logo */}
                    <rect width="120" height="30" rx="4" fill="#0C2654"/>
                    <path d="M20 8L16 15H20L24 8H20Z" fill="#3395FF"/>
                    <path d="M35 10H38V20H35V10ZM40 15C40 12.24 42.24 10 45 10C47.76 10 50 12.24 50 15C50 17.76 47.76 20 45 20C42.24 20 40 17.76 40 15ZM43 15C43 16.1 43.9 17 45 17C46.1 17 47 16.1 47 15C47 13.9 46.1 13 45 13C43.9 13 43 13.9 43 15ZM52 20V10H60V12.5H55V13.8H59V16.3H55V17.5H60V20H52ZM62 10H70V12.5H65V13.5H69V16H65V17.5H70V20H62V10ZM72 10H75V17.5H79V20H72V10ZM81 10H89V12.5H84V14H88V16.5H84V20H81V10ZM91 10H94L98 16V10H101V20H98L94 14V20H91V10Z" fill="white"/>
                  </svg>
                  <span className="text-xs text-slate-600 font-medium">Secure Payments</span>
                </>
              ) : (
                <>
                  <svg className="w-20 h-6" viewBox="0 0 120 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M119.295 7.23l-2.807 17.858a.569.569 0 0 0 .562.658h2.822c.469 0 .867-.34.939-.803l2.768-17.536a.57.57 0 0 0-.562-.659h-3.16a.571.571 0 0 0-.562.482z" fill="#253B80"/>
                  </svg>
                  <span className="text-xs text-slate-600 font-medium">Secure Payments</span>
                </>
              )}
